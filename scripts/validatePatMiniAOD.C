...
Double_t plotVarsCommon()
{
  ...
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  returnValue = plotVar( "recoCATopJetTagInfos_caTopTagInfosPAT__PAT.obj@.size()" );
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  returnValue = plotVar( "recoCATopJetTagInfos_caTopTagInfosPAT__PAT.obj.properties_.nSubJets" );
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  returnValue = plotVar( "recoCATopJetTagInfos_caTopTagInfosPAT__PAT.obj.properties_.minMass" );
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  returnValue = plotVar( "recoCATopJetTagInfos_caTopTagInfosPAT__PAT.obj.properties_.topMass" );
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  returnValue = plotVar( "recoCATopJetTagInfos_caTopTagInfosPAT__PAT.obj.properties_.wMass" );
  if (returnValue  < 0. ) return -returnSum;
  returnSum += returnValue;
  return returnSum;
}
